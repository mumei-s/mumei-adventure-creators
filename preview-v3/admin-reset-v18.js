(() => {
  ...
  function ensureTab(){
    ...
    if(!b){
      ...
      else{b=document.createElement('button');b.type='button';b.dataset.v18ResetTab='1';b.dataset.v17ResetTab='1';b.textContent='勝敗管理';tabs.insertBefore(b,tabs.querySelector('[data-owner-tab="logs"]')||null)}
    }
  }
